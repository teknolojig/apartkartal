...
export default function MarmaraUniversitesiPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        {/* Hero Section - Marmara Üniversitesi Özel */}
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Marmara Üniversitesi'ne kolay ulaşım, güvenli ve konforlu yaşam alanları
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-10">
                ...
                >
                  ...
                  <span>Marmara Üniversitesi'ne 25 Dk</span>
                </motion.div>
        ...
        {/* Marmara Üniversitesi Özel Bilgi Bölümü */}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Neden Marmara Üniversitesi Öğrencileri <span className="text-primary">Bizi Tercih Ediyor?</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Marmara Üniversitesi'ne kolay ulaşımımız ve sunduğumuz imkanlarla öğrencilerin güvenilir tercihi oluyoruz
              </p>
            </motion.div>
              ...
              {[
                {
                  icon: MapPin,
                  title: "Kolay Ulaşım",
                  description: "Marmara Üniversitesi'ne toplu taşıma ile kolayca ulaşabilirsiniz",
                  highlight: "25 DK"
                },
                {
                  icon: Train,
            ...
            >
              <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                  Marmara Üniversitesi Öğrencilerine Özel Fiyatlar!
                </h3>
        ...
        <section className="py-16 bg-primary">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Marmara Üniversitesi Öğrencileri İçin Güvenli Yurt
            </h2>

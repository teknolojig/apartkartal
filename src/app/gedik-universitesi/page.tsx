...
export default function GedikUniversitesiPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        {/* Hero Section - Gedik Üniversitesi Özel */}
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                Gedik Üniversitesi'ne sadece 5 dakika mesafede, güvenli ve konforlu yaşam alanları
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-10">
                ...
                >
                  ...
                  <span>Gedik Üniversitesi'ne 5 Dk</span>
                </motion.div>
        ...
        {/* Gedik Üniversitesi Özel Bilgi Bölümü */}
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Neden Gedik Üniversitesi Öğrencileri <span className="text-primary">Bizi Tercih Ediyor?</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Gedik Üniversitesi'ne yakınlığımız ve sunduğumuz imkanlarla öğrencilerin ilk tercihi oluyoruz
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                {
                  icon: MapPin,
                  title: "Yürüme Mesafesi",
                  description: "Gedik Üniversitesi'ne sadece 5 dakika yürüme mesafesindeyiz",
                  highlight: "5 DK"
                },
                {
                  icon: Train,
            ...
            >
              <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                  Gedik Üniversitesi Öğrencilerine Özel Fiyatlar!
                </h3>
        ...
        <section className="py-16 bg-primary">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Gedik Üniversitesi'ne En Yakın Kız Öğrenci Yurdu
            </h2>
